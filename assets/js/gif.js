$(document).ready(function () {
  ...
  let topics = ['Game of Thrones', 'Friends', 'Sherlock', 'Mad Men', 'Seinfeld', 'The Handmaids Tale', 'Westworld', 'Billions', 'The Simpsons', 'Big Little Lies'];
  let url = 'https://api.giphy.com/v1/gifs/search?api_key=dc6zaTOxFJmzC&limit=20&q=';
  ...
  $('.submit').on('click', function (event) {
    ...
    if ($('#userInput').val() != '') {
      let newButton = $('#userInput').val().trim();
